...
config.background_images_duration = 6000
config.background_images_fade_duration = 3000
...
"Kayan merdivenler yine yön değiştirdi, doğru koridoru bulmaya çalışıyoruz.",
"Seçmen Şapka yeni öğrenciler için sesini açıyor... bir dakika, o kadar da hızlı değil.",
"Yasak Orman'daki testraller bugün fazla meraklı, kapıları kapalı tutuyoruz.",
"Baykuş Kulesi'nde trafik var, mektubun sıraya girdi."
]
...
// Reference-based UI content. GameDetails always replaces server/map at runtime.
config.ui = {
  rules: [
    "Din, dil, ırk, cinsiyet ve milli değerlere hakaret yasak — profil ve isim dahil.",
    "Siyasi ve dini tartışma açmak veya katılmak yasak.",
    "Açık kanallarda küfür, hakaret ve tahrik yasak; özel odalarda herkesin rızası şart.",
    "Özel mesaj veya seste yaşananlar sunucuyu etkiliyorsa yönetim müdahale eder.",
    "Başka sunucuların adı, logosu, reklamı ve karşılaştırması yasak.",
    "Kişisel bilgi paylaşmak, taciz ve rahatsız edici mesajlar yasak.",
    "Cinsel içerik, kan ve şiddet görselleri yasak.",
    "Dolandırıcılık ve hesap istemek yasak; gizleyen de aynı cezayı alır.",
    "3 uyarı hakkın var; 4. uyarıda Discord ve sunucudan kalıcı uzaklaştırma."
  ],
  links: [
    { label: "DISCORD", text: "wyxen", icon: "◉", url: "" },
    { label: "WEB SİTE", text: "wyxenroleplay.com.tr", icon: "◎", url: "" },
  ]
}
